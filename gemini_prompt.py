...
def generate_prompt(case_id: str, progress_text: str, radiology_text: str) -> str:
    ...
    ---
    Provide your response in this EXACT format with no extra text:
    DECISION: [Yes/No]
    CONFIDENCE: [1-10], 1 being not confident to 10 being extremely confident.
    REASONING: [Brief explanation], a 2-4 sentence explanation for your decision.
    """
